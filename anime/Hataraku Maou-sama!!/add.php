...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO anime_list VALUES ('Ani0005','Hataraku Maou-sama!!','$score','$episode_progress','$start_date','$finish_date','$notes')";
    $query_run = mysqli_query($connect, $query);
    if ($query_run) {
        echo '<script type="text/javascript">
        alert("Anime berhasil disimpan");
        window.location.href="hatarakumaousama.html";
        </script>';
    } else {
        echo '<script type="text/javascript">
...
<head>
    ...
    <title>Hataraku Maou-sama!! - AniSuki</title>
</head>
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tittle-anime">Hataraku Maou-sama!!</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
