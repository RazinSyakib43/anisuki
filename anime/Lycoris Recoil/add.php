...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO anime_list VALUES ('Ani0003','Lycoris Recoil','$score','$episode_progress','$start_date','$finish_date','$notes')";
    $query_run = mysqli_query($connect, $query);
    if ($query_run) {
        echo '<script type="text/javascript">
        alert("Anime berhasil disimpan");
        window.location.href="lycorisrecoil.html";
        </script>';
    } else {
        echo '<script type="text/javascript">
...
<head>
    ...
    <title>Lycoris Recoil - AniSuki</title>
</head>
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tittle-anime">Lycoris Recoil</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
