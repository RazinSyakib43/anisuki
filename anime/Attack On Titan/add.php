...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO anime_list VALUES ('Ani0008','Attack On Titan','$score','$episode_progress','$start_date','$finish_date','$notes')";
    $query_run = mysqli_query($connect, $query);
    if ($query_run) {
        echo '<script type="text/javascript">
        alert("Anime berhasil disimpan");
        window.location.href="attackontitan.html";
        </script>';
    } else {
        echo '<script type="text/javascript">
...
<head>
    ...
    <title>Attack On Titan - AniSuki</title>
</head>
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tittle-anime">Attack On Titan</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
