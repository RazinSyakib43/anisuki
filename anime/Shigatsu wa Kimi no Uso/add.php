...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO anime_list VALUES ('Ani0012','Shigatsu wa Kimi no Uso','$score','$episode_progress','$start_date','$finish_date','$notes')";
    $query_run = mysqli_query($connect, $query);
    if ($query_run) {
        echo '<script type="text/javascript">
        alert("Anime berhasil disimpan");
        window.location.href="shigatsu.html";
        </script>';
    } else {
        echo '<script type="text/javascript">
...
<head>
    ...
    <title>Shigatsu wa Kimi no Uso - AniSuki</title>
</head>
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tittle-anime">Sword Art Online</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                        ...
                        <div class="col-3">
                            <div class="row">
                                <div class="col-12 mb-3" data-aos="fade-up" data-aos-once="true" data-aos-delay="200">
                                    ...
                                    <input type="number" class="form-control" name="episode_progress" min="1" max="12" required>
                                </div>
                                <div class="col-12 mb-3" data-aos="fade-up" data-aos-once="true" data-aos-delay="200">
                ...
                <div class="col-5">
                    ...
                    <div class="info mt-4">
                        <div class="footer-text mt-3">
                            <p class="text-white"> Temukan dan jelajahi anime favoritmu melalui review dan rekomendasi dengan AniSuki.
                                Selain itu, AniSuki juga merupakan portal berita yang membahas berita-berita
