...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO anime_list VALUES ('Ani0011','Steins;Gate','$score','$episode_progress','$start_date','$finish_date','$notes')";
...
<head>
    ...
    <title>Steins;Gate - AniSuki</title>
</head>
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tittle-anime">Steins;Gate</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
