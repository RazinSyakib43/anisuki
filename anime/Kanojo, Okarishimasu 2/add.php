...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO anime_list VALUES ('Ani0002','Kanojo, Okarishimasu 2nd Season','$score','$episode_progress','$start_date','$finish_date','$notes')";
    $query_run = mysqli_query($connect, $query);
    if ($query_run) {
        echo '<script type="text/javascript">
        alert("Anime berhasil disimpan");
        window.location.href="kanokari2.html";
        </script>';
    } else {
        echo '<script type="text/javascript">
...
<head>
    ...
    <title>Kanojo, Okarishimasu 2nd Season - AniSuki</title>
</head>
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tittle-anime">Kanojo, Okarishimasu 2nd Season</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                        ...
                        <div class="col-3">
                            <div class="row">
                                <div class="col-12 mb-3" data-aos="fade-up" data-aos-once="true" data-aos-delay="200">
                                    ...
                                    <input type="number" class="form-control" name="episode_progress" min="1" max="25" required>
                                </div>
                                <div class="col-12 mb-3" data-aos="fade-up" data-aos-once="true" data-aos-delay="200">
